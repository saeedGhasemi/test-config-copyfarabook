...
('بوف کور', 'The Blind Owl', 'صادق هدایت', 'نشر امیرکبیر', 'ادبیات', '/seed-images/book-boof.svg', 'شاهکار ادبیات مدرن فارسی', 0, 'night', 
...
('شازده کوچولو', 'The Little Prince', 'آنتوان دو سنت اگزوپری', 'نشر قطره', 'کودک و نوجوان', '/seed-images/book-prince.svg', 'داستانی شاعرانه از سفر یک شاهزاده کوچک', 45000, 'forest',
...
('کیمیاگر', 'The Alchemist', 'پائولو کوئیلو', 'نشر کاروان', 'ادبیات', '/seed-images/book-alchemist.svg', 'سفر معنوی یک چوپان به دنبال گنج', 60000, 'cafe',
...
('قلعه حیوانات', 'Animal Farm', 'جورج اورول', 'نشر ماهی', 'ادبیات سیاسی', '/seed-images/book-animalfarm.svg', 'تمثیلی درخشان از قدرت و فساد', 55000, 'rain',
